...
<body>
 <div class="container">
    <h1>Actualización de Estudiante</h1>
    <br>
      ...
      <div class="col-md-9">
        <form action="<?php echo site_url('StudentController/update') ?>" method="post" accept-charset="utf-8">
            <div class="form-group">
                ...
                <input type="text" name="document" class="form-control" id="document" placeholder="Inngrese el documento"
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" id="name" placeholder="Ingrese el nombre"
                value="<?= $student->name ?>">
                <!-- Error -->
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control" id="price" placeholder="Ingrese la contraseña"
